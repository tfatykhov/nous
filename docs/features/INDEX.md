...
| F022 | [Graph-Augmented Recall](F022-graph-augmented-recall.md) | ✅ Shipped | Wire existing graph_edges into recall pipeline, cross-type edges, contradiction detection, spreading activation |
